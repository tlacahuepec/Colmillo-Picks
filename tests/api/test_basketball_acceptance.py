"""Acceptance tests for basketball requests via the API."""
...
class TestBasketballAPIAcceptance:
    def test_basketball_request_accepted(self, client: TestClient) -> None:
    ...
    def test_basketball_with_specific_markets(self, client: TestClient) -> None:
        ...
        assert markets_seen <= {"points", "assists"}
    ...
    def test_unsupported_sport_rejected(self, client: TestClient) -> None:
        response = client.post(
            "/picks",
            json={
                "sport": "cricket",
